...
The current integrated branch combines this exact design head with accepted
PR61/PR65 integration. See [integration verification](design-security-integration.md)
for combined tests, the statistics-recovery placement correction, and release limits.
The original design-only scope and evidence below remain historical.
